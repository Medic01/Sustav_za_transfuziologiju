                    ...
                    ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          ...
                          _donationService
                              .acceptDonationAfterReservation(document.id, data)
                              .then((_) {
                            logger.info(
                                'Document successfully accepted after reservation');
                          }).catchError((error) {
                            logger.severe(
                                'Error accepting document after reservation: $error');
                          });
                        });
                      },
                      ...
                      onPressed: () {
                        showDialog(
                          ...
                          builder: (BuildContext context) {
                            ...
                            return AlertDialog(
                              title:
                                  Text(AppLocalizations.of(context)!.rejection),
                              content: TextField(
                                onChanged: (value) {
                              ...
                              actions: <Widget>[
                                ElevatedButton(
                                  onPressed: () {
                                    ...
                                    _donationService
                                        .rejectDonationAfterReservation(
                                            document.id, data, rejectionReason)
                                        .then((_) {
                                      logger.info(
                                          'Document successfully rejected after reservation');
                                    }).catchError((error) {
                                      logger.severe(
